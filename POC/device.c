...
#pragma NDIS_INIT_FUNCTION(POCRegisterDevice)
    ...
    )
{
    ...
    DEBUGP(DL_TRACE, "==>POCRegisterDevice\n");
   
    
    NdisZeroMemory(DispatchTable, (IRP_MJ_MAXIMUM_FUNCTION+1) * sizeof(PDRIVER_DISPATCH));
    
    DispatchTable[IRP_MJ_CREATE] = POCDispatch;
    DispatchTable[IRP_MJ_CLEANUP] = POCDispatch;
    DispatchTable[IRP_MJ_CLOSE] = POCDispatch;
    DispatchTable[IRP_MJ_DEVICE_CONTROL] = POCDeviceIoControl;
    ...
    DEBUGP(DL_TRACE, "<==POCRegisterDevice: %x\n", Status);
